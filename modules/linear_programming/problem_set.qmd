...
You are managing logistics for a food distribution network. There are **2 warehouses** (W1 and W2) and **5 cities** (C1 to C5) that need weekly shipments of food. Each warehouse can ship to each city — a total of **10 possible routes**. You want to meet the cities' demands at minimum cost while respecting warehouse capacities and various restrictions.
