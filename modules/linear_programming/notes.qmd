...
so its slope is $-\pi_W/\pi_C$. The labor constraint, which is the feasible edge leaving the
corn-only corner, is
...
- For a small change that preserves the current basis, a shadow-price approximation is
