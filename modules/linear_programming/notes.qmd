...
- Focus on three categories:
  1. Objective coefficients ($c_j$: unit profits, costs, or prices),
...
Changing an objective coefficient changes the direction of an iso-profit line, but it does
not move the feasible region. The question is therefore: how far can that line rotate before
another corner becomes better than the corn-only corner?

### Step 2: Write the relevant slopes

Use general unit-profit coefficients $c_W$ and $c_C$:
...
$$
C=\frac{Z}{c_C}-\frac{c_W}{c_C}W,
$$

so its slope is $-c_W/c_C$. The labor constraint, which is the feasible edge leaving the
corn-only corner, is
...
$$
-\frac{c_W}{c_C}\geq-\frac{3}{4}
\qquad\Longleftrightarrow\qquad
\frac{c_W}{c_C}\leq\frac{3}{4}.
$$
...
Hold corn's unit profit at $c_C=300$. Then

$$
\frac{c_W}{300}\leq\frac{3}{4}
\qquad\Longrightarrow\qquad
c_W\leq225.
$$

So wheat's unit profit can rise from $200 to $225 per acre without changing the unique
corn-only optimum. At $c_W=225$, the labor edge has the same slope as the iso-profit line:
...
Hold wheat's unit profit at $c_W=200$. Then

$$
\frac{200}{c_C}\leq\frac{3}{4}
\qquad\Longrightarrow\qquad
c_C\geq266.67.
$$

Corn's unit profit can fall from $300 to $266.67 per acre without changing the unique
corn-only optimum. At $c_C=266.67$, the same alternative-optima edge appears; below
...
3. If both crop prices change, why must we check the ratio $c_W/c_C$ rather than apply two
